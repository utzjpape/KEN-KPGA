...
label define lprov 1"Coast" 2"North Eastern" 3"Eastern" 4"Cental" 5"Rift Valley" 6"Western" 7"Nyanza" 8	"Nairobi" , replace

label values province lprov

order kihbs resid urban eatype province county cycle
