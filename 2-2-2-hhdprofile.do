...
putexcel set "${gsdOutput}/ch2_headprofile_wald.xls" , replace
...
putexcel set "${gsdOutput}/ch2_headprofile_wald_rural.xls" , replace
putexcel A3=("HH size") A4=("Dependency ratio") A5=("Share of children (0-4)") A6=("Share of children (5-14)") A7=("Share of males (15-65)") A8=("Share of females (15-65)") A9=("Members - no edu (15+)") A10=("Ave. years sch. (15+)") A11=(">=1 member is literate (15+)") A12=(">=1 member is wage employed") A13=("Diversified HH (1+ Sector)") A14=("Imp. drinking water")  A15=("Improved sanitation")  A16=("Main source light (electricity)")  A17=("HH electricity access")  A18=("HH has garbage collected")  A19=("Owns house")  A20=("Owns land") A21=("Area of ag. land (acres)")  A22=("HH has title")  A23=("HH owns motorcycle")  A24=("HH owns bicycle")  A25=("HH owns radio")  A26=("HH owns cell phone")  A27=("HH owns kerosene stove")  A28=("HH owns charcoal jiko")  A29=("HH owns mosquito net")  A30=("HH owns fridge") A31=("HH owns sofa")
putexcel C1=("2005") H1=("2015") B2=("Non-poor") C2=("Poor") D2=("P-value") E2=("Total") G2=("Non-poor") H2=("Poor") I2=("P-value") J2=("Total")
putexcel B3=matrix(hcount_2005)
putexcel D3=matrix(hcount_diff_2005)
...
putexcel set "${gsdOutput}/ch2_headprofile_wald_urban.xls" , replace
putexcel A3=("HH size") A4=("Dependency ratio") A5=("Share of children (0-4)") A6=("Share of children (5-14)") A7=("Share of males (15-65)") A8=("Share of females (15-65)") A9=("Members - no edu (15+)") A10=("Ave. years sch. (15+)") A11=(">=1 member is literate (15+)") A12=(">=1 member is wage employed") A13=("Diversified HH (1+ Sector)") A14=("Imp. drinking water")  A15=("Improved sanitation")  A16=("Main source light (electricity)")  A17=("HH electricity access")  A18=("HH has garbage collected")  A19=("Owns house")  A20=("Owns land") A21=("Area of ag. land (acres)")  A22=("HH has title")  A23=("HH owns motorcycle")  A24=("HH owns bicycle")  A25=("HH owns radio")  A26=("HH owns cell phone")  A27=("HH owns kerosene stove")  A28=("HH owns charcoal jiko")  A29=("HH owns mosquito net")  A30=("HH owns fridge") A31=("HH owns sofa")
putexcel C1=("2005") H1=("2015") B2=("Non-poor") C2=("Poor") D2=("P-value") E2=("Total") G2=("Non-poor") H2=("Poor") I2=("P-value") J2=("Total")
putexcel B3=matrix(hcount_2005)
putexcel D3=matrix(hcount_diff_2005)
...
tabout  province kihbs using "${gsdOutput}/ch2_headprofile_hhprovchars.xls", svy c(mean hhsize se hhsize) sum f(3 3)  clab(hhsize SE) sebnone replace
foreach var of varlist depen  aveyrsch  literacy  impwater impsan  elec_light  elec_acc {
	tabout  province kihbs using "${gsdOutput}/ch2_headprofile_hhprovchars.xls" , svy c(mean `var' se `var') sum f(3 3)  clab(`var' SE) sebnone append
}
*Select hh characteristics, asset ownership and access to services by NEDI category.
tabout  nedi kihbs using "${gsdOutput}/ch2_headprofile_hhnedichars.xls", svy c(mean hhsize se hhsize) sum f(3 3)  clab(hhsize SE) sebnone replace
foreach var of varlist depen  aveyrsch  literacy  impwater impsan  elec_light  elec_acc {
	tabout  nedi kihbs using "${gsdOutput}/ch2_headprofile_hhnedichars.xls" , svy c(mean `var' se `var') sum f(3 3)  clab(`var' SE) sebnone append
}
*Select hh characteristics, asset ownership and access to services by poverty category.
tabout  poor kihbs using "${gsdOutput}/ch2_headprofile_hhpovchars.xls", svy c(mean hhsize se hhsize) sum f(3 3)  clab(hhsize SE) sebnone replace
foreach var of varlist depen  aveyrsch  literacy  impwater impsan  elec_light  elec_acc {
	tabout  poor kihbs using "${gsdOutput}/ch2_headprofile_hhpovchars.xls" , svy c(mean `var' se `var') sum f(3 3)  clab(`var' SE) sebnone append
}
*National & Rural / Urban
tabout kihbs using "${gsdOutput}/ch2_headprofile_hhrurbchars.xls", svy c(mean hhsize se hhsize) sum f(3 3)  clab(hhsize SE) sebnone replace
tabout urban kihbs using "${gsdOutput}/ch2_headprofile_hhrurbchars.xls", svy c(mean hhsize se hhsize) sum f(3 3)  clab(hhsize SE) sebnone append

foreach var of varlist depen  aveyrsch  literacy  impwater impsan  elec_light  elec_acc {
	tabout  kihbs using "${gsdOutput}/ch2_headprofile_hhrurbchars.xls" , svy c(mean `var' se `var') sum f(3 3)  clab(`var' SE) sebnone append
	tabout  urban kihbs using "${gsdOutput}/ch2_headprofile_hhrurbchars.xls" , svy c(mean `var' se `var') sum f(3 3)  clab(`var' SE) sebnone append
}
...
merge 1:1 kihbs clid hhid using "$out\Merged_05_15\Income05_15.dta" , assert(match master) keep(match master) nogen keepusing(income_source* Ag_NAg_source* maj_income_s*)
svyset clid [pw=wta_hh], strata(strata)
...
putexcel set "${gsdOutput}/ch2_headprofile_wald2.xls" , replace
...
esttab reg_lncons_0_2005 using "${gsdOutput}/reg_lncons_0_2005.csv", label cells(b(star fmt(%9.3f)) se(fmt(%9.3f))) stats(r2 N, fmt(%9.2f %12.0f) labels("R-squared" "Observations"))   starlevels(* 0.1 ** 0.05 *** 0.01) stardetach  replace
esttab reg_lncons_0_2015 using "${gsdOutput}/reg_lncons_0_2015.csv", label cells(b(star fmt(%9.3f)) se(fmt(%9.3f))) stats(r2 N, fmt(%9.2f %12.0f) labels("R-squared" "Observations"))   starlevels(* 0.1 ** 0.05 *** 0.01) stardetach  replace
