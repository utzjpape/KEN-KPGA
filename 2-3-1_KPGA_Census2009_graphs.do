...
spmap MMR using "KenyaCountyPolys_coord.dta", id(_ID) clmethod(custom) fcolor(Reds) clbreaks(0 200 400 600 800 1000 2000 3000 4000) title(Maternal Mortality Ratio) note(Based on 2009 Census.)
