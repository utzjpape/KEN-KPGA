...
use "$in\kibhs15_16maincoping.dta" , clear
...
3 "Poverty line")) plotregion(margin(tiny))
...
vulnerable4!=., over(poor2) stack legend(on order(1 "Poor" 2 "Non-poor"))
*/
