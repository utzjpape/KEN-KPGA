...
forval i=1/9{
	...
	export excel using "${gsdOutput}/DfID-Poverty_Analysis/Elasticities_All_Final.xlsx", sheet("P_`i'") sheetreplace
...
export excel using "${gsdOutput}/DfID-Poverty_Analysis/Elasticities_All_Final.xlsx", sheet("SFI_All") sheetreplace
