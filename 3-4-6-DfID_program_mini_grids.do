...
keep sf_index
keep if _n==1
export excel using "${gsdOutput}/DfID-Poverty_Analysis/SFI_5.xlsx", firstrow(variables) replace
restore
...
export excel using "${gsdOutput}/DfID-Poverty_Analysis/Elasticities_P5.xlsx", firstrow(variables) replace
forval i=1/4 {
