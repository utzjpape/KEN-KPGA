...
export excel using "${gsdOutput}/Inequality/Figures_Final.xlsx", sheet("Raw_1") sheetreplace
erase "${gsdOutput}/Inequality/Raw_1.xls"

*Logit estimates
import delimited "${gsdOutput}/Inequality/Logit_Non-response.txt", clear 
export excel using "${gsdOutput}/Inequality/Figures_Final.xlsx", sheetreplace sheet("Logit")
...
forval i=1/6 { 
	...
	export excel using "${gsdOutput}/Inequality/Figures_Final.xlsx", sheetreplace sheet("Logit_`i'")
...
forval i=3/4 {
	...
	export excel using "${gsdOutput}/Inequality/Figures_Final.xlsx", sheet("Raw_`i'") sheetreplace
	erase "${gsdOutput}/Inequality/Raw_`i'.xlsx"
}

import delimited "${gsdOutput}/Inequality/Raw_5.csv", delimiter(tab) clear 
export excel using "${gsdOutput}/Inequality/Figures_Final.xlsx", sheet("Raw_5") sheetreplace
erase "${gsdOutput}/Inequality/Raw_5.csv"

import excel "${gsdOutput}/Inequality/Raw_6.xlsx", sheet("Sheet1") case(lower) allstring clear
export excel using "${gsdOutput}/Inequality/Figures_Final.xlsx", sheet("Raw_6") sheetreplace
...
export excel using "${gsdOutput}/Inequality/Figures_Final.xlsx", sheet("Raw_6_B") sheetreplace
