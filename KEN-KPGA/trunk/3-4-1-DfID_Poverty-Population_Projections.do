...
merge m:1 county using "${gsdData}/2-AnalysisOutput/dfid_analysis_county_section-3.dta", nogen assert(match) keepusing(countypw countyhw nedi poor vul_status malehead yrsch pgi severity)
...
save "${gsdData}/2-AnalysisOutput/dfid_kihbs_poverty_analysis.dta", replace
